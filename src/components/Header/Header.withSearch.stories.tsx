...
const meta: Meta<typeof Header> = {
  title: "Components/Header/With Search",
  component: Header,
  parameters: {
    layout: "fullscreen",
    ...
    docs: {
      description: {
        component: `# Header - With Search and Filter

Headers with integrated search input and filter dropdown, ideal for data tables, lists, and content management interfaces.
