...
import { UserManagementTable, User } from "../UserManagementTable/UserManagementTable";
...
const meta: Meta<typeof Drawer> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `# UserConfigDrawer

A comprehensive user configuration drawer that slides in from the right side, providing a tabbed interface for managing user access settings.
